...
namespace NSoup_UWP.Select
{
    ...
    internal abstract class Evaluator
    {
        ...
        public sealed class AttributeStarting : Evaluator
        {
            ...
            public override bool Matches(Element root, Element element)
            {
                System.Collections.ObjectModel.ReadOnlyCollection<NSoup_UWP.Nodes.Attribute> values = element.Attributes.AsList();

                foreach (NSoup_UWP.Nodes.Attribute attribute in values)
                {
        ...
        public sealed class AttributeWithValue : AttributeKeyPair
        {
            ...
            public override bool Matches(Element root, Element element)
            {
                return element.HasAttr(key) && value.Equals(element.Attr(key), StringComparison.CurrentCultureIgnoreCase);
            }
        ...
        public sealed class AttributeWithValueNot : AttributeKeyPair
        {
            ...
            public override bool Matches(Element root, Element element)
            {
                return !value.Equals(element.Attr(key), StringComparison.CurrentCultureIgnoreCase);
            }
