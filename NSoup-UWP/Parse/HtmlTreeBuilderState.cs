                ...
                switch (t.Type)
                {
                    ...
                    case Token.TokenType.StartTag:
                        ...
                        if (name.Equals("html"))
                        {
                            ...
                            foreach (NSoup_UWP.Nodes.Attribute attribute in startTag.Attributes)
                            {
                        ...
                        else if (name.Equals("input"))
                        {
                            ...
                            if (!el.Attr("type").Equals("hidden", StringComparison.CurrentCultureIgnoreCase))
                            {
                                tb.FramesetOk(false);
                            }
                        }
                        ...
                        else if (name.Equals("isindex"))
                        {
                            ...
                            foreach (NSoup_UWP.Nodes.Attribute attr in startTag.Attributes)
                            {
        ...
        protected class InTableState : HtmlTreeBuilderState
        {
            public override bool Process(Token t, HtmlTreeBuilder tb)
            {
                ...
                else if (t.IsStartTag())
                {
                    ...
                    {
                        if (!startTag.Attributes["type"].Equals("hidden", StringComparison.CurrentCultureIgnoreCase))
                        {
                            return AnythingElse(t, tb);
                        }
                        else
