    ...
    public abstract class Token
    {
        ...
        public abstract class Tag : Token
        {
            ...
            public void NewAttribute()
            {
                ...
                {
                    NSoup_UWP.Nodes.Attribute attribute;
                    if (_pendingAttributeValue == null)
                    {
                        attribute = new NSoup_UWP.Nodes.Attribute(_pendingAttributeName, "");
                    }
                    else
                    {
                        attribute = new NSoup_UWP.Nodes.Attribute(_pendingAttributeName, _pendingAttributeValue.ToString());
                    }
