...
namespace NSoup_UWP.Safety
{
    ...
    public class Whitelist
    {
        ...
        public bool IsSafeAttribute(string tagName, Element el, NSoup_UWP.Nodes.Attribute attr)
        {
        ...
        private bool TestValidProtocol(Element el, NSoup_UWP.Nodes.Attribute attr, HashSet<Protocol> protocols)
        {
